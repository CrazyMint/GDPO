...
"""Custom evaluation tasks for LightEval — n=16 samples, matching Sober Reasoning eval protocol."""
...
# All tasks use n=16 samples
avg_at_16_math = Metrics.avg_at_n_math(sample_params={"n": 16})
