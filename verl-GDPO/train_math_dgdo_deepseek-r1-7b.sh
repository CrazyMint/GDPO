...
# MATH DGDO Training Script - DeepSeek-R1-Distill-Qwen-7B
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-deepseek-r1-7B-math-DGDO}"
export CKPT_DIR="${CKPT_DIR:-/data/sxw240003/GDPO/results/math_dgdo_deepseek-r1-7b}"
...
python3 -u -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.val_kwargs.max_tokens=3000 \
    ...
    trainer.project_name=MATH_DGDO \
