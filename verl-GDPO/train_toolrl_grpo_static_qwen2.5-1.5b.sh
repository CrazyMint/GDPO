...
# ToolRL GRPO Training Script (Static Weights) - Qwen2.5-1.5B-Instruct
# Static format:correctness = 0.2:0.8
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-qwen2.5-1.5B-GRPO-static-tool}"
export CKPT_DIR="${CKPT_DIR:-/data/sxw240003/GDPO/results/toolrl_grpo_static_qwen2.5-1.5b}"
...
python3 -u -m verl.trainer.main_ppo \
    ...
    algorithm.gdpo_weights=[0.8,0.2] \
