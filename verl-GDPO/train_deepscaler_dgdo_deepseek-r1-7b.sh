...
# DeepscaleR DGDO Training Script - DeepSeek-R1-Distill-Qwen-7B
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-deepseek-r1-7B-deepscaler-DGDO}"
export CKPT_DIR="${CKPT_DIR:-/data/sxw240003/GDPO/results/deepscaler_dgdo_deepseek-r1-7b}"
