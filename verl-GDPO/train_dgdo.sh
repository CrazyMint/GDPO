...
export EXPERIMENT_NAME="qwen2.5-1.5B-DGDO-tool"
export CKPT_DIR="/data/sxw240003/GDPO/results/dgdo"
...
python3 -u -m verl.trainer.main_ppo \
    ...
    trainer.project_name=DGDO_Experiments \
