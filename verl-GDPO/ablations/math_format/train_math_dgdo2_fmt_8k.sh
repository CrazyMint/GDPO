...
# MATH DGDO2 (format+accuracy, no length, 8k): strict format, alpha=1.0, mw=0.15
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-DGDO2-math-fmt8k-a1.0-mw0.15}"
export CKPT_DIR="${CKPT_DIR:-/data/sxw240003/GDPO/results/math_dgdo2_fmt_8k_deepseek-r1-1.5b}"

export RAY_USAGE_STATS_ENABLED=0
export RAY_DISABLE_DOCKER_CPU_WARNING=1

# Reward: accuracy + format only (no length)
...
export DEEPSCALE_LENGTH_REWARD=0

# DGDO2 bounds: 2 components (no length)
