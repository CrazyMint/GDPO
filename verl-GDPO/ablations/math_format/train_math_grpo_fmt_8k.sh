...
# MATH GRPO (format+accuracy, no length, 8k): strict format baseline
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-GRPO-math-fmt8k}"
export CKPT_DIR="${CKPT_DIR:-/data/sxw240003/GDPO/results/math_grpo_fmt_8k_deepseek-r1-1.5b}"
