...
# MATH DGDO2 (format+accuracy+length, 8k): strict format + classic length, alpha=1.0, mw=0.15
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-DGDO2-math-fmtlen8k-a1.0-mw0.15}"
export CKPT_DIR="${CKPT_DIR:-/data/sxw240003/GDPO/results/math_dgdo2_fmtlen_8k_deepseek-r1-1.5b}"

export RAY_USAGE_STATS_ENABLED=0
export RAY_DISABLE_DOCKER_CPU_WARNING=1

# Reward: accuracy + format + length (all three)
export DEEPSCALE_CORRECT_REWARD=1.0
export DEEPSCALE_USE_FORMAT=1
export DEEPSCALE_FORMAT_REWARD=1.0
export DEEPSCALE_FORMAT_MODE=strict
export DEEPSCALE_LENGTH_REWARD=1.0
export DEEPSCALE_LENGTH_THRESHOLD=4000
export DEEPSCALE_LENGTH_MODE=classic

# DGDO2 bounds: 3 components
export DGDO2_BOUNDS_CORRECTNESS="0.0,1.0"
