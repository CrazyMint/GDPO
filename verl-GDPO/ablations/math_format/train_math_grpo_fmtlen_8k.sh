...
# MATH GRPO (format+accuracy+length, 8k): strict format + classic length baseline
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-GRPO-math-fmtlen8k}"
export CKPT_DIR="${CKPT_DIR:-/data/sxw240003/GDPO/results/math_grpo_fmtlen_8k_deepseek-r1-1.5b}"
