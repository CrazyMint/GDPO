...
# DeepscaleR GDPO Training Script with Conditional Length Reward
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-deepseek-r1-1.5B-deepscaler-GDPO-condlen}"
export CKPT_DIR="${CKPT_DIR:-/data/sxw240003/GDPO/results/deepscaler_gdpo_condlen_deepseek-r1-1.5b}"
