...
# DeepscaleR GDPO Training Script - Optimized for 4x NVIDIA B200 GPUs
#
# B200 (192GB HBM3e) allows larger batch sizes compared to A100 (80GB).
# This script is configured for maximum throughput on B200.

source "$(dirname $0)/.env"

# GPU Configuration - 4x B200
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-deepseek-r1-1.5B-deepscaler-GDPO-B200}"
export CKPT_DIR="${CKPT_DIR:-/data/sxw240003/GDPO/results/deepscaler_gdpo_b200}"
