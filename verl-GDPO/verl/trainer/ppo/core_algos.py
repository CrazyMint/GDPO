...
def compute_policy_loss(old_log_prob, log_prob, advantages, eos_mask, cliprange, cliprange_high=None):
    ...
    Args:
        ...
        eos_mask: `(torch.Tensor)`
            shape: (bs, response_length)
        cliprange: (float)
            The lower bound clip range (1 - cliprange) used in PPO. See https://arxiv.org/abs/1707.06347
        cliprange_high: (float, optional)
            The upper bound clip range (1 + cliprange_high). If None, uses cliprange for symmetric clipping.
