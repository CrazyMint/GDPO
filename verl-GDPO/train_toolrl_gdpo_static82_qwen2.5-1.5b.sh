...
# ToolRL GDPO Training Script (Static Weights) - Qwen2.5-1.5B-Instruct
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-qwen2.5-1.5B-GDPO-static-tool}"
export CKPT_DIR="${CKPT_DIR:-/data/sxw240003/GDPO/results/toolrl_gdpo_static_qwen2.5-1.5b}"
