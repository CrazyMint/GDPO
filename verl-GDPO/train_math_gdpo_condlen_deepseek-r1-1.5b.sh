...
# MATH GDPO Training Script - DeepSeek-R1-Distill-Qwen-1.5B
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-deepseek-r1-1.5B-math-GDPO-condlen}"
export CKPT_DIR="${CKPT_DIR:-/data/sxw240003/GDPO/results/math_gdpo_condlen_deepseek-r1-1.5b}"
