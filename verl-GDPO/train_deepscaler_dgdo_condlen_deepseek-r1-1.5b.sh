...
# DeepscaleR DGDO Training Script with Conditional Length Reward
# - Correctness reward: 1 if answer is correct
# - Length reward: 1 if correct AND response length <= threshold (conditioned mode)
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-deepseek-r1-1.5B-deepscaler-DGDO-condlen}"
export CKPT_DIR="${CKPT_DIR:-/data/sxw240003/GDPO/results/deepscaler_dgdo_condlen_deepseek-r1-1.5b}"

# Deepscaler reward configuration
