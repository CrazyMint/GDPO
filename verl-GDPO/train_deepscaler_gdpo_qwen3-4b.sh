...
# DeepscaleR GDPO Training Script - Qwen3-4B
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-qwen3-4B-deepscaler-GDPO}"
export CKPT_DIR="${CKPT_DIR:-/data/sxw240003/GDPO/results/deepscaler_gdpo_qwen3-4b}"
