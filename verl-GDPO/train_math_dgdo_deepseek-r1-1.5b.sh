...
# MATH DGDO Training Script - DeepSeek-R1-Distill-Qwen-1.5B
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-deepseek-r1-1.5B-math-DGDO}"
export CKPT_DIR="${CKPT_DIR:-/data/sxw240003/GDPO/results/math_dgdo_deepseek-r1-1.5b}"
