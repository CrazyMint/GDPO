...
# ToolRL GRPO Training Script - Qwen2.5-1.5B-Instruct
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-qwen2.5-1.5B-GRPO-tool}"
export CKPT_DIR="${CKPT_DIR:-/data/sxw240003/GDPO/results/toolrl_grpo_qwen2.5-1.5b}"
